...
| **srv-dns-01** | 10.0.40.3 | VLAN 40 — DMZ | DNS autoritativo / BIND9 (UDP/TCP 53) · Zona `uv.interno` con registros A para los 9 servidores | Todos los servidores internos · clientes VLAN 20 y VLAN 30 · scripts de despliegue (resolución por nombre) |
...
| **Registro DNS** | `srv-db-01.uv.interno → 10.0.10.2` |
...
| **Registro DNS** | `srv-files-01.uv.interno → 10.0.10.3` |
...
| **Registro DNS** | `srv-ntp-01.uv.interno → 10.0.10.4` |
...
| **Registro DNS** | `srv-web-03.uv.interno → 10.0.10.5` |
...
| **Registro DNS** | `srv-dhcp-01.uv.interno → 10.0.10.6` |
...
| **Registro DNS** | `srv-web-01.uv.interno → 10.0.40.2` |
...
| srv-ntp-01.uv.interno | 10.0.10.4 |
| srv-dhcp-01.uv.interno | 10.0.10.6 |
| srv-dns-01.uv.interno | 10.0.40.3 |
| srv-smtp-01.uv.interno | 10.0.40.4 |
...
| **Registro DNS** | `srv-smtp-01.uv.interno → 10.0.40.4` |
...
| **Consumidores principales** | Ciudadanos / víctimas del conflicto armado · Nginx LB · srv-db-01 |
| **Registro DNS** | `srv-web-02.uv.interno → 10.0.40.5` |
...
[Firewall / Router de borde]
    ...
    │       ├── srv-dns-01   10.0.40.3  DNS autoritativo (uv.interno)
